  ...
  return (
    ...
    <Card className="ms-5 mt-3" style={{ width: "1035px", height: "344px"}} key={index}>
                <div>
                  ...
                  <div className="position-absolute text-center" style={{ marginLeft: "770px" }}>
                    <h3 className="">Kereta Api</h3>
                    <p className="fs-5 fw-semibold text-secondary">sabtu, 21 Februari 2022</p>
                  ...
                  <div className="d-flex">
                    ...
                    <div className="ms-5 mt-4">
                      <div>
                        <h5 className="fw-bold">{transactions.ticket.start_station_id.kota}</h5>
                        <h5 className="text-secondary">{transactions.ticket.start_station_id.name}</h5>
                      </div>
                      <div className="mt-5">
                        <h5 className="fw-bold">{transactions.ticket.start_station_id.kota}</h5>
                        <h5 className="text-secondary">{transactions.ticket.start_station_id.name}</h5>
