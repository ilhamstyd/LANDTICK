...
func (h *handlerProfile) FindProfiles(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, dto.SuccessResult{Status: "SUCCESS", Message: "Profile data successfully obtained", Data: profile})
}
...
func (h *handlerProfile) CreateProfile(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, dto.SuccessResult{Status: "SUCCESS", Message: "Profile data created successfully", Data: profile})
}
...
func (h *handlerProfile) UpdateProfile(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, dto.SuccessResult{Status: "SUCCESS", Message: "Profile data updated successfully", Data: data})
}
...
func (h *handlerProfile) DeleteProfile(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, dto.SuccessResult{Status: "SUCCESS", Message: "Profile data deleted successfully", Data: data})
}
